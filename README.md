...
Выполненную работу необходимо предоставить в виде отдельного репозитория. Репозиторий должен включать в себя страницу index.html в качестве точки входа в приложения.
